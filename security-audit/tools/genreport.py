...
""",
 ...
 fix="""<p>Shared depth counter (modeled on <code>kMaxImportDepth=256</code>,
 <code>cssstylesheet.cpp:970</code>) applied in <code>consumeComponent</code>/<code>consumeBlock</code>,
 selector/at-rule recursion, parsing (nesting limit), and layout.</p>""",
 config="Configurable max nesting depth, <strong>default ~512</strong>.",
)
