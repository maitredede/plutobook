...
void plutobook_set_max_table_span(unsigned int max)
{
    plutobook::engineLimits()->setMaxTableSpan(max);
}

void plutobook_set_max_use_expansion(unsigned int max)
{
    plutobook::engineLimits()->setMaxUseExpansion(max);
}

void plutobook_set_max_use_depth(unsigned int max)
{
...
void plutobook_set_max_page_count(unsigned int max)
{
    plutobook::engineLimits()->setMaxPageCount(max);
}

void plutobook_set_max_counter_length(unsigned int max)
{
    plutobook::engineLimits()->setMaxCounterLength(max);
}

void plutobook_set_max_column_count(unsigned int max)
{
    plutobook::engineLimits()->setMaxColumnCount(max);
}

void plutobook_set_max_text_node_length(unsigned int max)
{
    plutobook::engineLimits()->setMaxTextNodeLength(max);
}

void plutobook_set_max_table_nesting_depth(unsigned int max)
{
